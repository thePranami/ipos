...
public class BreakageSaleResponse {
    @SerializedName("data")
    @Expose
    private List<BreakageSaleModel> data = null;
    @SerializedName("msg")
    @Expose
    private String msg;
    ...
    public List<BreakageSaleModel> getData() {
        return data;
    }

    public void setData(List<BreakageSaleModel> data) {
        this.data = data;
    }
